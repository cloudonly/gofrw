...
import (
	...
	"github.com/luomu/gofrw/hive/job"
)
...
var jobsCell = cell.Module(
	"job-module",
	"Implements the job module",

	job.Cell,
	cell.Provide(newExampleCell),
	cell.Invoke(func(_ *exampleCell) {}),
)
...
func (ex *exampleCell) doSomeWork() error {
	ex.logger.Info("start do some work.")
	ex.workChan <- struct{}{}
	return nil
}
